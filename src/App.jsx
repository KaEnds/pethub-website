...
function App() {
  ...
  return (
    ...
    <h1 className='text-5xl mt-40 text-red-600'>test deployment</h1>

    <p className='mt-10'>test daisy ui</p>
    ...
    <button className="btn my-10 btn-secondary" onClick={()=>document.getElementById('my_modal_1').showModal()}>open modal</button>
